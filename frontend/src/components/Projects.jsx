...
export default function ProjectShowcasePage() {
  ...
  const imageMap = {
    ...
    3: 'Projectspictures/TFirstHouse.png',
    4: 'Projectspictures/TSecHouse.png',
  };
  ...
  useEffect(() => {
    axios.get('/api/projects')
      .then(res => {
        ...
        const combined = [...actives, ...futures];

        const withImages = combined.map((p, idx) => ({
          ...p,
        ...
        setActiveProjects(withImages.slice(0, actives.length));
        setFutureProjects(withImages.slice(actives.length));
      })
