const Users = ({ id, name, region, priority, period, status, actions }) => { 
  return (
    <div className="flex flex-row space-x-4 border-b py-4 px-6 border-zinc-700/60 w-full text-zinc-700 font-bold">
...
export default function ViewAudit() {
  return (
    <div className="px-6 py-8 flex flex-col">
      ...
      <div className="flex flex-col space-y-2 p-6 bg-red-400 rounded-lg shadow-[0px_0px_10px_0px_rgba(0,0,0,0.25)]">
