const Users = ({ place, id, name, region, priority, period, actions, isLast }) => {
  return (
    <div className={`flex flex-row space-x-4 py-4 px-6 ${isLast ? '' : 'border-b border-zinc-700/60'} text-zinc-700 font-bold`}>
      <div className="w-1/5 whitespace-nowrap overflow-hidden truncate">{place}</div>
...
export default function WaitList() {
  return (
    <div className="px-6 py-8 flex flex-col">
      <div className="text-4xl text-zinc-700 font-bold py-2">Waiting List</div>
      <div className="text-zinc-700/80 text-2xl font-bold py-2">
        View waiting list by region.
      </div>
      <div className="py-8">
