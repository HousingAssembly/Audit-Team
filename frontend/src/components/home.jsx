      ...
      <div className="flex flex-col space-y-20 w-full pt-11 sm:pt-12 overflow-hidden">
        <div className="flex flex-col lg:flex-row mx-12 justify-center items-center">
          ...
          <div className="w-1/2 text-center">
            <div className="flex flex-col justify-center items-center">
              <div class="w-[498px] h-[504px] text-center justify-center text-zinc-700 text-2xl sm:text-[85px] font-bold font-['Sumana'] leading-[120px] sm:leading-[155px] mt-[-20px] sm:mt-[10px] tracking-widest sm:tracking-wider">DECENT HOUSING FOR ALL</div>
              <button className="flex bg-palette-red hover:bg-red-900 font-medium text-[15px] sm:text-[25px] text-white px-4 sm:px-7 py-2 rounded-xl m-4 items-center justify-center mt-[-400px] sm:mt-0" onClick={() => setIsViewAuditOpen(true)}>
                <span className="font-bold mr-2 -mt-1 whitespace-nowrap">View Audit</span>
                <img src="arrow-right.svg" alt="Arrow" className="w-5 h-5 sm:w-8 sm:h-8 sm:ml-1 inline-block" />
              </button>
            </div>       
          </div>
        </div>
        ...
        <div className="relative w-full overflow-hidden overflow-visible bg-white">
          <div className="min-h-screen">
            ...
            <section id="about" className="relative w-full scroll-mt-[-140px] mt-[-35px] sm:mt-0">
            ...
            <section id="contact" className="scroll-mt-[100px]">
              <div className="relative flex justify-center px-4 sm:px-12">
                <div className="relative z-20 bg-black text-white py-24 w-[400px] sm:w-[900px] h-[420px] sm:h-[740px] max-w-4xl rounded-md shadow-lg transform rotate-6 mt-[-120px] sm:mt-[-46px] sm:mb-0 mb-[-40px]">
                  <div className="text-center text-[20px] sm:text-[48px] font-bold -rotate-[6deg] tracking-wider mt-[-35px] sm:mt-0 sm:ml-0 ml-[-20px]">CONTACT</div>
                  ...
                  <div className="mt-16 transform -rotate-6 px-12 md:px-12">
                    <div className="flex flex-row gap-10 items-start sm:justify-center text-center sm:text-left ml-[35px] sm:ml-[20px] sm:mt-0 mt-[-30px]">
                      <div className="flex flex-col items-center sm:items-end gap-[40px] sm:gap-[75px]">
                        <img src="email.png" alt="Email Icon" className="h-5 sm:h-10 min-w-[42px] object-contain" />
                        <img src="location.png" alt="Pin Icon" className="h-8 sm:h-14 w-a  uto object-contain mr-0 sm:mr-1" />
                      </div>
