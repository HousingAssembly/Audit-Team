...
export default function ProjectShowcasePage() {
  return (
    <div className="flex flex-col w-full py-12 space-y-20 mg=12">
      {/* Logo */}
    ...
    >
      ...
      >
        ...
        >
          ...
          <p>
            <strong>Municipality:</strong> {project.municipality}
          </p>
          <p>
      ...
      <div className="flex flex-col space-y-32 w-full">
        {futureProjects.map((project, index) => (
          ...
          >
            {/* House */}
            <div className="w-1/2 flex justify-center">
              <img src={project.image} alt={`Future House ${index + 1}`} className="h-50 object-contain" />
            </div>
